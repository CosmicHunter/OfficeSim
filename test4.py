...
env = OfficeEnv()
# this is the testing script for the trained model
# python test4.py --model_dir data/output --phase test --policy newtestpolicy1/internal --visualize --test_case 0
def main():
	...
	if args.visualize:
		...
		# to generate trajectory data text files uncomment below , and comment above
		# explorer.run_k_episodes(env.case_size[args.phase], args.phase,imitation_learning = True, print_failure=True , gen_txt_data = True)
