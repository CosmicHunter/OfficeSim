...
env = OfficeEnv()
# in order to visualize the models. for state action type of model
# python visualizer_state_action.py --model_dir data/output --phase test --policy newtestpolicy1/internal --test_case 0
# python visualizer_state_action.py --model_dir data/output --phase test --policy newtestpolicy1 --test_case 0
def main():
	...
	if args.model_dir is not None:
		...
		if args.il:
			...
			if os.path.exists(os.path.join(args.model_dir, 'resumed_rl_model.pth')):
				...
				model_weights = os.path.join(args.model_dir, 'state_action_model.pth')
